...
struct FakeMarkdownEntryD: Identifiable, Hashable {
    let path: String
...
enum FakeMarkdownDataD {
    static let entries: [FakeMarkdownEntryD] = [
        FakeMarkdownEntryD(
    ...
    static func entry(for path: String) -> FakeMarkdownEntryD? {
