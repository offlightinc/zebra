...
enum GoalsDesignTokens {
    ...
    static let pickerFontSize: CGFloat = 13
    static let pickerHorizontalPadding: CGFloat = 8
    static let pickerOuterHorizontalPadding: CGFloat = 8
    ...
    static let metaFontSize: CGFloat = 13
    static let metaPillCornerRadius: CGFloat = 4
    static let metaPillHorizontalPadding: CGFloat = 8
    static let metaPillVerticalPadding: CGFloat = 3
