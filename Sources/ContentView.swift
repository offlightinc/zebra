...
struct ContentView: View {
    ...
    private func commandPaletteSurfaceKindLabel(for panelType: PanelType) -> String {
        ...
        case .email:
            return String(localized: "commandPalette.kind.email", defaultValue: "Email")
        }
    }
    ...
    private func commandPaletteSurfaceKeywords(for panelType: PanelType) -> [String] {
        ...
        case .email:
            return ["email", "mail", "gmail", "inbox", "thread"]
        }
    }
...
struct VerticalTabsSidebarFooter: View {
    ...
    var body: some View {
        ...
        HStack(spacing: 6) {
            // Vault chip gets the flexible side of the row so long vault
            // names can truncate instead of pushing the sync indicator out.
