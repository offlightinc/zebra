...
public struct ZebraGBrainRuntimeOnboardingStore {
    ...
    provider_choices = [
        {"id": "openai-codex", "label": "OpenAI Codex account login", "env": "", "auth_type": "oauth", "openclaw_provider": "openai", "openclaw_auth": "openai", "openclaw_model": "openai/gpt-5.6-sol", "hermes_provider": "openai-codex", "hermes_model": "gpt-5.6-sol", "hermes_base_url": "https://chatgpt.com/backend-api/codex", "hermes_base_env": "HERMES_CODEX_BASE_URL", "hermes_api_mode": "codex_responses"},
