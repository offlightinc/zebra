...
public enum BrainFrontmatterWriter {
    ...
    public static func applyScalar(at filePath: String, key: String, value: String?) {
    ...
    public static func setScalar(_ key: String, to value: String?, in source: String) -> String {
        let newline = detectNewline(in: source)
        let lines = source.components(separatedBy: newline)
