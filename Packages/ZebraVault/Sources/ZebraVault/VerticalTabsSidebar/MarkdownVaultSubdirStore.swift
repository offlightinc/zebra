...
public protocol VaultSubdirEntry: Identifiable, Hashable, Sendable {
...
@MainActor
public class MarkdownVaultSubdirStore<Entry: VaultSubdirEntry>: ObservableObject {
    ...
    public func replace(_ updated: Entry) {
    ...
    public func _seedForPreview(entries: [Entry], rootPath: String?, isScanning: Bool) {
